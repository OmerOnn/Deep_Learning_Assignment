...
def main():
    ...
    parser.add_argument("--epochs", type=int, default=5)          # לשמור הוגנות עם שאר Exp1
    parser.add_argument("--lr", type=float, default=1e-3)
    parser.add_argument("--margin", type=float, default=0.2)      # margin טיפוסי ל-triplet
    ...
    # רק זהויות שמופיעות ב-pairsDevTrain
