...
MODEL_CKPT = "results/experiment1_loss/triplet_random_m0.2/20260519_130331/model_best.pth"
MARGIN_NAME = "m0.2" 
OUTPUT_DIR = f"results/experiment1_loss/triplet_eval_random_{MARGIN_NAME}"
