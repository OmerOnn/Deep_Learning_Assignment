...
MODEL_CKPT = "results/experiment2_backbone/koch_triplet_semihard_m0.2/emb128_20260519_152115/model_best.pth"
MARGIN_NAME = "m0.2"
OUTPUT_DIR = f"results/experiment2_backbone/koch_eval_{MARGIN_NAME}"
