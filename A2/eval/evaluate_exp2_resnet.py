...
MODEL_CKPT = "results/experiment2_backbone/resnet18_triplet_semihard_m0.2/emb128_20260519_154440/model_best.pth"
MARGIN_NAME = "m0.2"
OUTPUT_DIR = f"results/experiment2_backbone/resnet_eval_{MARGIN_NAME}"
