...
writer = SummaryWriter(
    log_dir=os.path.join(TENSORBOARD_DIR, "melody_v1")
)
...
# ==========================================
model = MelodyConditionedLSTM_V1(
...
print(f"\n==========================================")
print(f"BEST MELODY_V1 MODEL TRAINING METRICS:")
print(f"==========================================")
...
print(f"Best checkpoint saved to: /checkpoints/melody_v1_model_best.pth")
print(f"==========================================\n")
