...
from classes.melody_variant_3 import MelodyGatedLSTM_V3
...
log_filename = os.path.join(RESULTS_DIR, f"melody_v3_train_log.txt")
sys.stdout = Logger(log_filename)

print(f"--- Output is being saved to: {log_filename} ---")

writer = SummaryWriter(
    log_dir=os.path.join(TENSORBOARD_DIR, "melody_v3")
)
...
# ==========================================
# 3. Initialize Melody V3 Model
# ==========================================
model = MelodyGatedLSTM_V3(
...
# ==========================================
print("\nStarting Melody Variant 3 training...\n")
...
model_save_filename = os.path.join(CHECKPOINT_DIR, f"melody_v3_model_best.pth")
...
print("\nTraining Melody Variant 3 finished successfully!")
...
print(f"\n==========================================")
print(f"BEST MELODY_V3 MODEL TRAINING METRICS:")
print(f"==========================================")
