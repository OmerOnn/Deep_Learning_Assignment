...
# Import existing pipeline and the new V2 class
from data.data_preprocessing_melody import prepare_melody_pipeline, collate_fn_melody
from classes.melody_variant_2 import MelodyConditionedLSTM_V2
...
log_filename = os.path.join(RESULTS_DIR, f"melody_v2_train_log.txt")
...
# ==========================================
# 3. Initialize Melody V2 Model
# ==========================================
model = MelodyConditionedLSTM_V2(vocab_size, EMBEDDING_DIM, HIDDEN_DIM, NUM_LAYERS).to(device)
...
# ==========================================
print("\nStarting Melody Variant 2 training...\n")
...
for epoch in range(EPOCHS):
    ...
    for batch_inputs, batch_targets, batch_melodies in train_loader:
        ...
        # Forward pass combining embedding and melody at each time step
    ...
    if val_ppl < best_val_ppl:
        ...
        model_save_filename = os.path.join(CHECKPOINT_DIR, f"melody_v2_model_best.pth")
...
print("\nTraining Melody Variant 2 finished successfully!")
...
# ==========================================
model_save_filename = os.path.join(CHECKPOINT_DIR, f"melody_v2_model.pth")
torch.save(model.state_dict(), model_save_filename)
