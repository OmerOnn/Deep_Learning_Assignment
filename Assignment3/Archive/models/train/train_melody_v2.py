...
writer = SummaryWriter(
    log_dir=os.path.join(TENSORBOARD_DIR, "melody_v2")
)
...
# ==========================================
model = MelodyConditionedLSTM_V2(
...
print(f"\n==========================================")
print(f"BEST MELODY_V2 MODEL TRAINING METRICS:")
print(f"==========================================")
...
print(f"Best checkpoint saved to: /checkpoints/melody_v2_model_best.pth")
print(f"==========================================\n")
